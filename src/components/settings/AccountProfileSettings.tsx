...
export function AccountProfileSettings({ backHref }: { backHref: string }) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setSaveError(formatProfileError(err, "Could not save profile."));
    } finally {
  ...
  const editableEmpty = Object.values(draft).every((v) => v.trim() === "");
